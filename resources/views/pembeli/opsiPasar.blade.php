...
<div class="row justify-content-center mt-2">
    <div class="col-sm-3 text-center my-1">
        <a class="btn btn-secondary btn-lg btn-block" href="{{ route('pembeliorderss') }}"><img src="https://marvel-live.freetls.fastly.net/canvas/2020/3/5d5124973e2c44a89c91d7765d92e6d1?quality=95&fake=.png" heigth="30" width="30">Pasar Ikan</a>
    </div>
    <div class="col-sm-3 text-center my-1">
